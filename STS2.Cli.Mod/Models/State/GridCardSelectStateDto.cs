...
/// <summary>
///     Grid-based card selection screen state DTO.
///     Contains information about cards available for selection from a grid-based card selection overlay.
///     Covers: card removal, upgrade, transform, enchant, and generic grid selections
///     (including combat-triggered selections like Headbutt, Hologram, etc.).
/// </summary>
[SuppressMessage("ReSharper", "PropertyCanBeMadeInitOnly.Global")]
[SuppressMessage("ReSharper", "UnusedAutoPropertyAccessor.Global")]
public class GridCardSelectStateDto
{
    /// <summary>
